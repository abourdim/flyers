...
.wrap{{position:relative;z-index:1;padding:48px 56px;height:100%;display:flex;flex-direction:column}}
...
.hero{{margin:16px 0}}
.hero-label{{font-family:'Space Grotesk',sans-serif;font-size:14px;color:#00c853;text-transform:uppercase;letter-spacing:4px;border:1px solid rgba(0,200,83,.3);display:inline-block;padding:4px 16px;margin-bottom:12px}}
...
.price-bar{{display:flex;align-items:center;justify-content:space-between;background:rgba(0,200,83,.05);border:1px solid rgba(0,200,83,.15);border-radius:8px;padding:20px 28px;margin:12px 0}}
...
.qr-section{{display:flex;align-items:center;gap:24px;background:rgba(0,200,83,.05);border:1px solid rgba(0,200,83,.15);border-radius:8px;padding:24px 28px;margin:12px 0}}
.qr-left{{flex:1}}
...
.qr-desc{{font-size:14px;color:rgba(255,255,255,.5);margin:8px 0}}
...
.info-row{{display:flex;gap:12px;margin:12px 0}}
...
.ci{{margin:0 8px}}
.footer{{text-align:center;margin-top:auto;padding-top:10px;border-top:1px solid rgba(255,255,255,.06)}}
...
.terminal{{margin:40px;border:2px solid #414868;border-radius:12px;height:calc(100% - 80px);display:flex;flex-direction:column;overflow:hidden}}
...
.term-body{{flex:1;padding:36px 44px;display:flex;flex-direction:column;overflow:hidden}}
...
.section-lbl{{font-family:'JetBrains Mono',monospace;font-size:12px;color:#9ece6a;margin:16px 0 10px}}
.cmds{{font-family:'JetBrains Mono',monospace;margin-bottom:14px}}
...
.price-bar{{display:flex;align-items:center;gap:20px;background:rgba(122,162,247,.05);border:1px solid #414868;border-radius:8px;padding:16px 24px;margin:10px 0;font-family:'JetBrains Mono',monospace}}
...
.qr-section{{display:flex;align-items:center;gap:20px;background:rgba(158,206,106,.04);border:1px solid #414868;border-radius:8px;padding:20px 24px;margin:10px 0}}
.qr-left{{flex:1}}
...
.contact-bar{{text-align:center;font-family:'JetBrains Mono',monospace;font-size:11px;color:#565f89;margin:10px 0;padding:8px 0;border-top:1px solid #414868}}
.ci{{margin:0 6px}}
.footer{{text-align:center;margin-top:auto;padding-top:8px;border-top:1px solid #414868}}
...
.wrap{{position:relative;z-index:1;padding:48px 56px;height:100%;display:flex;flex-direction:column;align-items:center;text-align:center}}
...
.hero{{margin:20px 0}}
.hero-label{{font-family:'Orbitron',sans-serif;font-size:13px;color:#8338ec;letter-spacing:6px;text-transform:uppercase;margin-bottom:14px}}
...
.hero-desc{{font-size:16px;color:rgba(224,214,255,.6);margin-top:14px;max-width:650px;line-height:1.5}}
...
.pills{{display:flex;flex-wrap:wrap;justify-content:center;gap:10px;margin:14px 0}}
...
.contact-bar{{text-align:center;font-size:11px;color:rgba(224,214,255,.3);margin:10px 0;padding:8px 0;border-top:1px solid rgba(255,255,255,.05)}}
.ci{{margin:0 6px}}
.footer{{text-align:center;margin-top:auto;padding-top:8px;border-top:1px solid rgba(255,255,255,.05)}}
...
.wrap{{position:relative;z-index:1;padding:48px 60px;height:100%;display:flex;flex-direction:column}}
...
.hero-emoji{{font-size:{int(tsize*0.45)}px;margin-right:10px}}
.hero-desc{{font-size:16px;color:rgba(44,24,16,.6);margin:12px auto;max-width:650px;line-height:1.6}}
.divider{{width:200px;height:2px;background:linear-gradient(90deg,transparent,#c8960c,transparent);margin:16px auto}}
.section-lbl{{font-family:'El Messiri',sans-serif;font-size:18px;color:#1b6b3a;text-align:center;margin:14px 0}}
.features{{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:14px}}
...
.pills{{display:flex;flex-wrap:wrap;justify-content:center;gap:10px;margin:12px 0}}
...
.price-bar{{display:flex;align-items:center;justify-content:space-between;background:rgba(200,150,12,.05);border:1px solid rgba(200,150,12,.15);border-radius:12px;padding:18px 28px;margin:10px 0}}
.price-item{{display:flex;align-items:center;gap:10px}}
.price-icon{{font-size:26px}}
...
.qr-section{{display:flex;align-items:center;gap:24px;background:rgba(27,107,58,.04);border:1px solid rgba(27,107,58,.12);border-radius:12px;padding:22px 28px;margin:10px 0}}
.qr-left{{flex:1}}
...
.contact-bar{{text-align:center;font-size:11px;color:rgba(44,24,16,.35);margin:10px 0;padding:8px 0;border-top:1px solid rgba(200,150,12,.1)}}
.ci{{margin:0 6px}}
.footer{{text-align:center;margin-top:auto;padding-top:8px;border-top:1px solid rgba(200,150,12,.1)}}
...
.wrap{{position:relative;z-index:2;padding:48px 56px;height:100%;display:flex;flex-direction:column}}
.toprow{{display:flex;align-items:center;gap:16px;margin-bottom:8px}}
...
.hero-emoji{{font-size:{int(tsize*0.45)}px;margin-right:10px}}
.hero-desc{{font-size:15px;color:rgba(176,176,176,.6);margin:10px 0;max-width:700px;line-height:1.5}}
.section-lbl{{font-size:11px;color:#00ff41;letter-spacing:3px;text-transform:uppercase;margin:16px 0 10px}}
...
.qr-section{{display:flex;align-items:center;gap:20px;background:rgba(0,255,65,.03);border:1px solid rgba(0,255,65,.1);border-radius:2px;padding:20px 24px;margin:10px 0;position:relative}}
...
.contact-bar{{text-align:center;font-size:11px;color:rgba(176,176,176,.3);margin:10px 0;padding:8px 0;border-top:1px solid rgba(255,255,255,.04)}}
.ci{{margin:0 6px}}
.footer{{text-align:center;margin-top:auto;padding-top:8px;border-top:1px solid rgba(255,255,255,.04)}}
...
.page{{background:#1e1e2e;border:1px solid #313244;border-top:none;border-radius:0 0 12px 12px;margin:0 40px;padding:36px 44px;flex:1;display:flex;flex-direction:column;overflow:hidden}}
.toprow{{display:flex;align-items:center;gap:14px;margin-bottom:6px}}
...
.hero-emoji{{font-size:{int(tsize*0.45)}px;margin-right:10px}}
.hero-desc{{font-size:15px;color:#a6adc8;margin:10px 0;max-width:650px;line-height:1.5}}
.section-lbl{{font-size:12px;color:{colors[1]};letter-spacing:2px;text-transform:uppercase;margin:14px 0 10px;font-weight:700}}
.features{{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px}}
...
.price-bar{{display:flex;align-items:center;gap:16px;background:rgba(249,226,175,.04);border:1px solid #313244;border-radius:10px;padding:16px 22px;margin:8px 0}}
.price-item{{display:flex;align-items:center;gap:10px}}
...
.qr-section{{display:flex;align-items:center;gap:20px;border:1px solid #313244;border-radius:10px;padding:18px 22px;margin:8px 0;background:rgba(166,227,161,.03)}}
.qr-left{{flex:1}}
...
.contact-bar{{text-align:center;font-size:10px;color:#6c7086;margin:8px 0;padding:6px 0;border-top:1px solid #313244}}
.ci{{margin:0 6px}}
.footer{{text-align:center;margin-top:auto;padding-top:6px;border-top:1px solid #313244}}
...
.hero-desc{{font-size:16px;color:rgba(184,212,232,.6);margin:10px 0;max-width:700px;line-height:1.5}}
.section-lbl{{font-family:'Exo 2',sans-serif;font-size:12px;color:#ffe66d;letter-spacing:3px;text-transform:uppercase;margin:16px 0 10px}}
.features{{display:flex;flex-direction:column;gap:8px;margin-bottom:14px}}
...
.price-bar{{display:flex;align-items:center;gap:16px;background:rgba(255,230,109,.04);border:1px solid rgba(255,230,109,.12);border-radius:8px;padding:16px 22px;margin:10px 0}}
.price-item{{display:flex;align-items:center;gap:10px}}
.price-icon{{font-size:24px}}
...
.qr-section{{display:flex;align-items:center;gap:20px;background:rgba(0,212,255,.03);border:1px solid rgba(0,212,255,.1);border-radius:8px;padding:20px 24px;margin:10px 0}}
.qr-left{{flex:1}}
...
.contact-bar{{text-align:center;font-size:11px;color:rgba(184,212,232,.3);margin:10px 0;padding:8px 0;border-top:1px solid rgba(255,255,255,.05)}}
.ci{{margin:0 6px}}
.footer{{text-align:center;margin-top:auto;padding-top:8px;border-top:1px solid rgba(255,255,255,.05)}}
...
.wrap{{position:relative;z-index:1;padding:44px 56px;height:100%;display:flex;flex-direction:column;align-items:center;text-align:center}}
.toprow{{display:flex;align-items:center;gap:14px;margin-bottom:6px}}
...
.hero-desc{{font-size:16px;color:rgba(240,230,255,.55);margin:12px auto;max-width:650px;line-height:1.5}}
.section-lbl{{font-family:'Bangers',cursive;font-size:24px;color:#ff6b35;letter-spacing:3px;margin:16px 0 12px}}
.features{{display:grid;grid-template-columns:1fr 1fr;gap:12px;width:100%;margin-bottom:14px}}
...
.qr-section{{display:flex;align-items:center;gap:20px;background:rgba(59,206,172,.05);border:2px solid rgba(59,206,172,.15);border-radius:14px;padding:20px 24px;margin:10px 0;width:100%;text-align:left}}
.qr-left{{flex:1}}
...
.contact-bar{{text-align:center;font-size:11px;color:rgba(240,230,255,.3);margin:10px 0;padding:8px 0;border-top:2px solid rgba(255,255,255,.05)}}
.ci{{margin:0 6px}}
.footer{{text-align:center;margin-top:auto;padding-top:8px;border-top:2px solid rgba(255,255,255,.05)}}
